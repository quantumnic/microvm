...
pub fn generate_dtb_smp(
    ...
    let isa_str = "rv64imafdcvsu_zicsr_zifencei_zicbom_zicboz_zicbop_zicond_zihintpause_zawrs_zacas_zabha_zfa_zimop_zcmop_zba_zbb_zbs_zbc_zbkb_zbkc_zbkx_zknd_zkne_zknh_zkr_zve32f_zve64f_zve64d_zvbb_zvkg_zvkned_zvknhb_zvksed_zvl128b_sstc_zicntr_zihpm_svinval_svnapot_svpbmt_svadu_smstateen_ssstateen_sscofpmf_smcntrpmf_sdtrig";
